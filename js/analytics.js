...
function renderAnalytics(){
  ...
  analyticsBody.querySelectorAll('.analytics-seg-btn').forEach(btn => {
  ...
  analyticsBody.querySelectorAll('.analytics-row').forEach(row => {
...
document.getElementById('closeAnalytics').addEventListener('click', () => analyticsOverlay.classList.remove('open'));
analyticsOverlay.addEventListener('click', (ev) => { if(ev.target === analyticsOverlay) analyticsOverlay.classList.remove('open'); });
